...
HEADINGS = [
    ...
    "Từ vựng: nghĩa, collocation và sắc thái",
    "Chữ Hán trọng tâm",
    "Ngữ pháp và tổ chức diễn ngôn",
    "Hội thoại theo register",
    "Nghe có chiến lược",
    "Đọc và kiểm tra lập luận",
    "Phát âm và nhịp diễn ngôn",
    "Văn hóa giao tiếp không tuyệt đối hóa",
    "Luyện có hướng dẫn",
