...
test('production runtime keeps canonical progress writes blocked and only exposes a verified bridge', () => {
  ...
  assert.ok(index.indexOf('hsk-content-feature-flags.js?v=2b1.0') < index.indexOf('hsk-developer-preview.js?v=2b1.0'));
  assert.ok(index.indexOf('hsk-developer-preview.js?v=2b1.0') < index.indexOf('developer-control-center.js?v=2b1.0'));
