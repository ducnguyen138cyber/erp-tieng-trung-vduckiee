...
test('welcome mascot uses inline SVG groups around the current WebP artwork', () => {
  ...
  assert.match(indexSource, /vduckie-mascot-v87\.css\?v=87\.6/);
...
test('wing selection stops on the annotated shoulder-to-armpit seam without entering the torso', () => {
  assert.match(indexSource, /id="vduckieWingShape" d="M164 214C142 215 116 222 94 232L95 174L83 122H0V286H72C88 294 105 302 122 307C126 284 144 235 164 214Z"/);
