...
console.log(JSON.stringify({ qualityGate: result.quality.qualityGate, phase2aDataGate: result.quality.phase2aDataGate, structuralCoverage: result.quality.structuralCoverage, releaseReadinessCoverage: result.quality.releaseReadinessCoverage, phase2Allowed: result.quality.phase2Allowed, productionCurriculumAllowed: result.quality.productionCurriculumAllowed, validationErrors: result.validation.summary.errors, duplicateBlockers: result.duplication.summary.blockers, reports: Object.keys(result.reports).sort() }, null, 2));
