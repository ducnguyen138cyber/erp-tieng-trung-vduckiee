...
function writeReports({ facts, units, lessons, vocabulary, characters, grammar, exercises, assessments }) {
  ...
  const report = {
    ...
    validation: { schema: "pending-quality-engine", officialRows: "501-1000 exact", targetExamples: "500/500", lessonAssignment: "500/500 exactly once", audioStatus: "36/36 script-ready-audio-pending", exerciseFormats: formats, productionWrites: false }
  };
