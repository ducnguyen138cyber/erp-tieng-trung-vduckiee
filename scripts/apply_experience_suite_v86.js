...
const loaderTag = '  <script src="./assets/v86/experience-suite-loader-v86.js?v=87.3"></script>';
...
if (!index.includes('experience-suite-loader-v86.js?v=87.3') || !index.includes('home-layout-stability-v87.3.js?v=87.3') || !index.includes('community.js?v=86.7')) {
  throw new Error('Không thể gắn bản ổn định layout v87.3 vào index.html.');
}

fs.writeFileSync(indexPath, index, 'utf8');
console.log('Applied stable home layout v87.3');
