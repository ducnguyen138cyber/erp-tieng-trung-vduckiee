...
var files=[
  "./assets/v83/learning-cockpit-v83.js?v=83.1",
  "./assets/v84/retention-center-v84.js?v=84.1",
...
function load(index){
  if(index>=files.length){root.__VDUCKIE_EXPERIENCE_V86_READY__=true;try{document.dispatchEvent(new CustomEvent("vduckie:experience-v86-ready",{detail:{version:"86.1"}}))}catch(error){}return;}
