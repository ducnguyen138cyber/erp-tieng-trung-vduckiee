...
function load(index){
  if(index>=files.length){root.__VDUCKIE_EXPERIENCE_V86_READY__=true;try{document.dispatchEvent(new CustomEvent("vduckie:experience-v86-ready",{detail:{version:"86.2"}}))}catch(error){}return;}
