(function (root, document) {
  ...
  var lastTest = { button: "—", requestedState: "idle", resolvedState: "idle", note: "" };
  ...
  function details(node) {
    ...
    return node ? {
      ...
      animationClass: node.getAttribute("data-v95-animation-class") || "is-idle", duration: node.getAttribute("data-v95-animation-duration") || "0",
  ...
  document.addEventListener("vduckie:developer-animation-test", function (event) { lastTest = Object.assign({}, lastTest, event.detail || {}); refresh(); });
