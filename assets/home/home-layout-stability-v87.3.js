(function(root){
  ...
  if(root.__VDUCKIE_LAYOUT_STABILITY_V873__)return;
  root.__VDUCKIE_LAYOUT_STABILITY_V873__=true;
  ...
  function settle(){
    ...
    function check(){
      ...
      if(Date.now()-started<4500)root.setTimeout(check,32);
      else reveal();
    }

    root.setTimeout(check,0);
  }
